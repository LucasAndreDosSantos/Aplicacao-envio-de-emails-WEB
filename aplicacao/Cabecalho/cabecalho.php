  <!-- Importando o CSS dos estilos do cabecalho -->
...
<body>
  ...
  <div class="cabecalho"> 
    <header class="header">
        ...
        <h3 class="textoEmail"> Envio de E-mail oficial </h3>
        <h6 class="fraseEmail"> Aplicação que envia e-mails automaticamente</h6>
   </header>
  </div>